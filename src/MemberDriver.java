...
public class MemberDriver {
                            ...
                            case 0:
                                if (changeMenu == 0) {
                                    ...
                                    while (!validInput) {
                                        ...
                                        try {
                                            confirmChange = editMember_input.nextInt();
                                            validInput = true;
                                        } catch (java.util.InputMismatchException e) {
                                            // Handle the exception if the input is not an integer
                                            System.out.println("Invalid input. Please enter an integer.");
    ...
    public static void addMember (Staff staff) {
        ...
        while (!validInput) {
            System.out.print("\nHow many member you want to add in(0 for exit): ");
            try {
                memberAddIn = addMember_input.nextInt();
                validInput = true;
        ...
        if (memberAddIn != 0) {
            ...
            while (!validInput) {
                ...
                try {
                    confirmation = addMember_input.nextInt();
                    validInput = true;
                }
                catch (java.util.InputMismatchException e) {
                    // Handle the exception if the input is not an integer
    ...
    public static void deleteMember(Staff staff) {
        ...
        if (deleteId.charAt(0) != '0') {
            ...
            while (!validInput) {
                ...
                try {
                    confirmDelete = deleteMember_input.nextInt();
                    validInput = true;
                }
                catch (java.util.InputMismatchException e) {
                    // Handle the exception if the input is not an integer
                    System.out.println("Invalid input. Please enter an integer.");
                    deleteMember_input.nextLine();
                }
            }
