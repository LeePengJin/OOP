...
public class GiftCard {
    ...
    //========================================== Reload Gift Card Validation ===========================================
    public boolean reloadGiftCardValidation(GiftCard gc, String inputReload){
    ...
    public GiftCard reloadGiftCard(GiftCard gc, double reloadAmount){
        gc.balance += reloadAmount;
